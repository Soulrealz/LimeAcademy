...
contract Bank {
    ...
    function withdraw(uint _amount) public {
        ...
        (bool sent, ) = msg.sender.call{value: _amount}(""); //reentrancy can happen here because balances is updated too late
        require(sent, "Failed to send Ether");

        balances[msg.sender] -= _amount;

        logger.log(msg.sender, _amount, "Withdraw"); //once this line is reached its gg.
    }
}
